...
Current release: **[0.1.1](https://github.com/gmgauthier/earblaster/releases/tag/v0.1.1)** (2026-09-09).
...
- Formats via the host plugins: MP3, Ogg, FLAC, WAV, M4A at minimum
...
**M0–M6 are in the tree.** Window, spin, sound, playlist, cover, EQ/prefs/keyboard, and packaging (`debian/`, `scripts/release.sh`). Tagged **0.1.1** after a drag-and-drop double-add fix and AppImage GStreamer bundling.
...
```
sudo apt install ./earblaster_0.1.1-1_amd64.deb
```
